...
class BasenBMS : public PollingComponent {
 ...
 protected:
  ...
  // These commands are sent at startup to retrieve version, barcode and parameters
  struct {
    uint16_t command;
    bool received;
  } startup_commands_[6] = {
    {COMMAND_BMS_VERSION, false},
    {COMMAND_BARCODE, false},
    {COMMAND_PARAMETERS, false},
    {COMMAND_ALARM_PARAMETERS, false},
    {COMMAND_HEATING_ON_TEMPERATURE, false},
    {COMMAND_HEATING_OFF_TEMPERATURE, false}
  };
